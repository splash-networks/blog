...
<div style="text-align: center;">
    <img src="../assets/images/captive-portal-api/hotspot-server-profile.png" alt="MikroTik hotspot server profile with the DNS name, HTTPS login and SSL certificate highlighted" width="70%" />
</div>
...
![MikroTik DHCP server Options tab listing option CAPPORT with code 114 and the captive portal API URL as its value](../assets/images/captive-portal-api/dhcp-options.png)

In Option Sets create a new Option Set and select the Option created in the previous step.

![MikroTik DHCP Option Sets tab with a CAPPORT option set that contains the CAPPORT option](../assets/images/captive-portal-api/dhcp-option-sets.png)

Go to DHCP tab and in the default settings select the Option Set created in the last step.

![MikroTik DHCP server settings with the DHCP Option Set field set to CAPPORT](../assets/images/captive-portal-api/dhcp-server-option-set.png)

MikroTik will now start to advertise DHCP Option 114. It can be seen in a packet capture.

![Wireshark capture of a DHCP ACK packet showing Option 114 DHCP Captive-Portal with the captive portal API URL](../assets/images/captive-portal-api/wireshark.png)
...
<div style="text-align: center;">
    <img src="../assets/images/captive-portal-api/api-json.png" alt="api.json file open in Notepad with the venue-info-url line added and highlighted" width="70%" />
</div>
...
<div style="text-align: center;">
    <img src="../assets/images/captive-portal-api/api-response.png" alt="Browser showing the captive portal API JSON response with captive true and the venue-info-url value" width="80%" />
</div>
...
<div style="text-align: center;">
    <img src="../assets/images/captive-portal-api/android-home.png" alt="Android notification panel showing a connected MikroTik Wi-Fi network with the Tap to view website notification" width="60%" />
</div>

Similarly, on iOS a Portal section will appear in the Wi-Fi network's settings with a link to open the portal page.

![iOS Wi-Fi network settings with a highlighted Portal section and an Open Portal Page link](../assets/images/captive-portal-api/ios-settings.png)